...
public class MacUtil {
  ...
  public static void main(String[] args) {
	  //System.out.println(MacUtil.getLinuxMACAddress());
	  System.out.println(MacUtil.getMacAddress());
	  //System.out.println(MacUtil.getOSName());
	  //System.out.println(MacUtil.getSystemRoot());
	 //System.out.println(MacUtil.getUnixMACAddress());
	  //System.out.println(MacUtil.getWindowXPMACAddress(""));
	  //System.out.println(MacUtil.getWindow7MACAddress());
}
}  